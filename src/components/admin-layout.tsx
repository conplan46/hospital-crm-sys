			...
			<div className="drawer-side">
				...
				<ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
					...
					<Link href="/admin/clinicians">
						<li
							className={`m-2 flex rounded-xl bg-[#ffffff] p-4 ${router.pathname === "/admin/clinicians"
					...
					<Link href="/admin/patients">
						<li
							className={`m-2  flex rounded-xl bg-[#ffffff] p-4 ${router.pathname === "/admin/patients"
								? "border-gradient border-2"
								: ""
								}`}
							style={{ width: "100%" }}
					...
					<Link href="/admin/pharmacies">
						<li
							className={`m-2 flex rounded-xl bg-[#ffffff] p-4 ${router.pathname === "/admin/pharmacies"
								? "border-gradient border-2"
								: ""
								}`}
							style={{ width: "100%" }}
