import { Center, FormControl, FormErrorMessage, FormLabel, Input, Select, Button, Wrap } from "@chakra-ui/react";
...
export default function NewUserPage() {
  ...
  const onSubmit: SubmitHandler<OnboardingData> = (data) => { console.log(data) }
